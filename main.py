...
if __name__ == "__main__":
    ...
    parser.add_argument("--receive_port", type=int, default=12365, help="The port to receive data from the server.")
    parser.add_argument("--send_port", type=int, default=12366, help="The port to send data to the server.")
